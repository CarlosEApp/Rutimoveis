...
document.getElementById('P_resutTodosIMV').innerHTML=`Total de ${itens} Imóveis encontrados!`;
...
list.appendChild(li);
sessionStorage.setItem('itensList1',itens)
document.getElementById('P_resutPesquisa').innerHTML=`Total de ${itens} Imóveis encontrados!`;
