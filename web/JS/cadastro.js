...
var rua = document.getElementById('rua').value; //3
var bairro = document.getElementById('bairro').value; //4
var select1 = document.getElementById('selectListId_moradia').value; //5
var select2 = document.getElementById('select_venda').value; //6
var valorA = document.getElementById('valorLoc').value; //7
var valorC = document.getElementById('valor').value; //8
var codigo = document.getElementById('inputCodigo').value; //9
var numero = document.getElementById('numero').value; //10
var uf = document.getElementById('input_UF').value; //11
var cep = document.getElementById('input_cep').value; //12
var desconto = document.getElementById('desconto').value; //13
var Vcond = document.getElementById('valorCond').value; //14
var Viptu = document.getElementById('valorIPTU').value; //15
var areaM = document.getElementById('Area_metragen').value; //16
var quintal = document.getElementById('Quint_quant').value; //17
var quintalM = document.getElementById('Quint_metragen').value; //18
var sala = document.getElementById('salas_quant').value; //19
var salaM = document.getElementById('salas_metragen').value; //20
var varanda = document.getElementById('varanda_quant').value; //21
var quartos = document.getElementById('Quarto_quant').value; //22
var suites = document.getElementById('suite_quant').value; //23
var banheiros = document.getElementById('banheiro_quant').value; //24
var piscinas = document.getElementById('piscinas_quant').value; //25
var piscinaM = document.getElementById('piscinas_metragen').value; //26
var playg = document.getElementById('playg_quant').value; //27
var playgM = document.getElementById('playg_metragen').value; //28
var Andares = document.getElementById('andar_quant').value; //29
var Vgaragem = document.getElementById('vagas_quant').value; //30
var duplex = document.getElementById('duplex').value; //31
var triplex = document.getElementById('Triplex').value; //32
var NomeP = document.getElementById('nome_proprietario').value; //33
var telP = document.getElementById('Tel_proprietario').value; //34
var cpfP = document.getElementById('cpf_proprietario').value; //35
var end = document.getElementById('endereço').value; //36
var estadoAT = document.getElementById('estadoAimóvel').value; //65
var eatd = document.getElementById('dadaETA').value; //66
var eath = document.getElementById('horaETA').value; //67
